...
const requiredIds = [
  ...
  'stage', 'mainVideo', 'cameraPreview', 'referencePreview', 'emptyStage',
...
if (!html.includes('js/capcut-ui.js')) throw new Error('Le contrôleur mobile n’est pas chargé.');
...
if (!gradle.includes("versionName '2.2.0'") || !gradle.includes('versionCode 4')) {
  throw new Error('La version APK 2.2.0 n’est pas configurée.');
}

console.log(`Validation réussie : timeline unique, ${scripts.length} scripts, export 1080p et caméra Android native vérifiés.`);
